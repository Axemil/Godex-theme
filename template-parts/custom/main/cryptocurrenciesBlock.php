<section class="section-block">
    <div class="section_title">
        ...
        <a href="<?php echo get_home_url(null, "/category")."/crypto-currencies";?>">
            <span>More</span>
    ...
    <?php 
        $posts = get_posts( array(
            'numberposts' => 3,
            'category_name'    => "crypto-currencies",
            'orderby'     => 'date',
            'order'       => 'DESC',
            'include'     => array(),
            'exclude'     => array(),
    ...
    <div class="newsBanner-block">
        <div class="newsBanner_main">
            ...
            <div class="category_block">
                <a href="<?php echo get_home_url(null, "/category")."/crypto-currencies";?>">Cryptocurrencies</a>
