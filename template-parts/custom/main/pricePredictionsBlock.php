<section class="section-block">
    <div class="section_title">
        ...
        <a href="<?php echo get_home_url(null, "/category")."/price-predictions";?>">
            <span>More</span>
    ...
    <div class="alter_news_block">
        <div class="left_side_block">
            <div class="category_block">
                <a href="<?php echo get_home_url(null, "/category")."/price-predictions";?>">Price Predictions</a>
        ...
        <div class="main_side_block">
            ...
            <div class="main_side_text">
                <div style="padding-top: 0; padding-bottom: 16px;" class="category_block"><a href="<?php echo get_home_url(null, "/category")."/Price Predictions";?>">Price Predictions</a></div>
