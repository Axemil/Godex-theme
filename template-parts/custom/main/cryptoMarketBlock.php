<section class="section-block">
    <div class="section_title">
        <h2>Crypto market</h2>
        <a href="<?php echo get_home_url(null, "/category")."/crypto-market";?>">
            <span>More</span>
        ...
        <div class="news_main_list">
            <div class="news_item">
                ...
                <div class="category_block">
                    <a href="<?php echo get_home_url(null, "/category")."/crypto-market";?>">Crypto market</a>
            ...
            <div class="sidebar_post_item">
                ...
                <div class="sidebar_post_text">
                    <a class="sidebar_author" href="<?php echo get_home_url(null, "/category")."/crypto-market";?>">Crypto market</a>
